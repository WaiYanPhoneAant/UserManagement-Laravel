...
@section('header','User Creation Form')
@section('content')


<div class="mt-3 mx-2">
    <h1 class="fw-light m-2 mb-5">User Creation Form</h1>
    <div class="form mt-3">
            ...
            @csrf
                <div class="name-input row m-0">
                    <div class="mb-3 col-md-3">
                        ...
                        <input type="text" value="{{old('name')}}" name="name" class="form-control" id="name" aria-describedby="emailHelp" placeholder="Your Name">
                        @error('username')
                      ...
                      <div class="mb-3 col-md-3">
                        ...
                        <input type="email" value="{{old('email')}}" name="email" class="form-control" placeholder="Your Email" id="email">
                        @error('email')
                            <span class="text-danger m-1">*{{$message}}</span>
                        @enderror
                    </div>
                      <div class="mb-3 col-md-3">
                        ...
                        <input type="number"  value="{{old('phone')}}" name="phone" class="form-control" placeholder="Your Phone" id="phone" aria-describedby="emailHelp">
                        @error('phone')
                            <span class="text-danger m-1">*{{$message}}</span>
                        @enderror
                    </div>
                      ...
                      <div class=" mb-3 col-md-3 p-3">
                        <input name="is_active"  class="form-check-input" type="checkbox" value="1" id="flexCheckChecked"  {{old('is_active')?'checked':""}}checked>
                    ...
                    <!-- input for password-field -->
                        <div class="password-gp row m-0">
                            <div class="mb-3 col-md-3 col-sm-5">
                                ...
                                <input type="text" value="{{old('username')}}" name="username" class="form-control" placeholder="Enter username" id="userName" aria-describedby="emailHelp">
                            @error('username')
                                <span class="text-danger m-1">*{{$message}}</span>
                            @enderror
                            </div>
                ...
                <div class="d-flex justify-content-center mt-3">
                    <button type="submit" class="mt-5 mb-5 align-items-center btn btn-lg btn-primary">Create</button>
                </div>
        </form>
    </div>
</div>
